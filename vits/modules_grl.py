...
#             GradReverse(),
#             tfa.layers.WeightNormalization(tf.keras.layers.Conv1D(embed_dim, kernel_size=5, padding=2)),
#             tf.keras.layers.ReLU(),
#             tfa.layers.WeightNormalization(tf.keras.layers.Conv1D(embed_dim, kernel_size=5, padding=2)),
#             tf.keras.layers.ReLU(),
#             tfa.layers.WeightNormalization(tf.keras.layers.Conv1D(spk_dim, kernel_size=5, padding=2))
#         )
